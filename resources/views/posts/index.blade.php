    ...
    <div class="w-8/12 bg-white p-6 rounded-lg">
        <form action="{{ route('posts')}}" method="post" class="mb-4">
            ...
            <div class="mb-4">
                ...
                <!-- <textarea placeholder="Post Something!" name="body" id="body" cols="30" rows="4" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('body') border-red-500 @enderror">
                </textarea> -->
                <textarea id="body" name="body" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('body') border-red-500 @enderror" placeholder="Write your thoughts here..."></textarea>
...
@endif
        ...
        <div class="mb-4 border border-indigo-600 rounded-lg p-4">
            ...
            <div class="flex items-center">
                <form action="{{ route('posts.edit' , $post->id)}}" method="post" class="mr-1">
                    @csrf
                    <button type="submit" class="text-blue-500">Edit</button>
                </form>
                <form action="{{ route('posts.pdelete' , $post->id)}}" method="post" class="mr-1">
                    @csrf
