...
<div class="flex justify-center">
    <div class="w-8/12 bg-white p-6 rounded-lg">
        <form action="{{ url('posts/update/'.$posts->id)}}" method="post" class="mb-4">
            @csrf
            <div class="mb-4">
